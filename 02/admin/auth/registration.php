        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav navbar-center" id="navbar-navlist">
                    ...
                    <li class="nav-item">
                        <a data-scroll href="../../admin/auth/registration.php" class="nav-link">Awards</a>
                    </li>
                    <li class="nav-item">
                        <a data-scroll href="../../admin/auth/registration.php" class="nav-link">Listings</a>
                    </li>
                    <li class="nav-item">
                        <a data-scroll href="../../admin/auth/registration.php" class="nav-link">Teams</a>
                    </li>                    
                    <li class="nav-item">
                        <a data-scroll href="../../admin/auth/registration.php" class="nav-link">Contact</a>
                    </li>
                    <li class="nav-item">
