...
// Replace the following line with your actual logic to check if the user is an admin
$isAdmin = true; // Replace this with your actual logic to check if the user is an admin

// Check if the form is submitted
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    
    // If the user is not an admin, display alert and redirect
    if (!$isAdmin) {
